...
class AlertRule(BaseModel):
    ...
    rule_type: Mapped[str] = mapped_column(String(50), nullable=False)  # price_drop, threshold, deal_appeared
    ...
    notification_method: Mapped[str] = mapped_column(String(50), default="console")  # console, email, file
