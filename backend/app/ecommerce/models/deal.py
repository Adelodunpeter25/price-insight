...
class Deal(BaseModel):
    ...
    deal_type: Mapped[str] = mapped_column(String(50), default="price_drop")  # price_drop, coupon, sale
    ...
    def __repr__(self) -> str:
        ...
        return f"<Deal(id={self.id}, product_id={self.product_id}, discount={self.discount_percent}%)>"
